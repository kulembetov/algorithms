...
const testHeapSort = () => {
  ...
  console.assert(
    JSON.stringify(heapSort([-3, -1, -2, 0, 2])) ===
  ...
  console.assert(
    JSON.stringify(heapSort([3, 1, 2, 3, 1])) ===
  ...
  // test 6: sorted array
  console.assert(
    JSON.stringify(heapSort([1, 2, 3, 4, 5])) ===
      JSON.stringify([1, 2, 3, 4, 5]),
  ...
  console.assert(
    JSON.stringify(heapSort([5, 4, 3, 2, 1])) ===
      JSON.stringify([1, 2, 3, 4, 5]),
