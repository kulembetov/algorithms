...
const testMergeSort = () => {
  ...
  console.assert(
    JSON.stringify(mergeSort([4, 2, 5, 1, 3])) ===
  ...
  console.assert(
    JSON.stringify(mergeSort([-3, -1, -2, 0, 2])) ===
  ...
  console.assert(
    JSON.stringify(mergeSort([3, 1, 2, 3, 1])) ===
  ...
  // test 6: sorted array
  console.assert(
    JSON.stringify(mergeSort([1, 2, 3, 4, 5])) ===
      JSON.stringify([1, 2, 3, 4, 5]),
  ...
  console.assert(
    JSON.stringify(mergeSort([5, 4, 3, 2, 1])) ===
      JSON.stringify([1, 2, 3, 4, 5]),
